Profile: PLLabHealthcareServiceLaboratoryServiceCatalog
Parent: HealthcareService
Id: pl-lab-healthcareService-laboratoryServiceCatalog
Title: "HealthcareService: Laboratory Service Catalog (PL)"
...
* specialty 0..0
* location 1..1 MS
* location only Reference(PLLabLocationLaboratory)
* name 1..1 MS
* comment 0..0
* extraDetails 0..0
* photo 0..0

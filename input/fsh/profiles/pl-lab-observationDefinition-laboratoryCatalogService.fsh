Profile: PLLabObservationDefinitionLaboratoryCatalogService
Parent: ObservationDefinition
Id: pl-lab-observationDefinition-laboratoryCatalogService
Title: "ObservationDefinition: Laboratory Catalog Service (PL)"
...
* code.coding[customCode].system 1..1 MS
* code.coding[customCode].version 0..1 MS
* code.coding[customCode].code 1..1 MS
* code.coding[customCode].display 1..1 MS
* code.coding[customCode].userSelected 0..0
* code.text 0..0
